Feature: TODO List Management
  ...
  As a user, I want to manage my TODO list effectively so that I can keep track of my tasks and ensure they are completed.
  ...
  Scenario: Edit the current TODO
    Given I add new TODO with message "This is a new TODO"
